    ...
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column'}}>
      ...
      <main className="landing-main">
        <section className="hero">
          ...
          <p style={{color:'var(--color-muted)',marginTop:12, maxWidth:680}}>AQTEV helps clinics, coaches, and wellness teams capture reliable daily measurements, track progress over time, and turn observations into simple, shareable action plans. Secure and team-friendly, AQTEV is built to support better client outcomes.</p>
